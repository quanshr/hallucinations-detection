...
# Prepare dataset
# dataset = load_dataset('csv', data_files={'data': os.path.join(config.rawdata_dir, 'train-train.csv')})['data']
...
# Train the model
trainer.train(resume_from_checkpoint='results/checkpoint-6676')
